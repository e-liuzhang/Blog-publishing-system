						...
						<div class="row">
							...
							<div class="col-12">
								<div class="form__group">
									...
									<input name="title" type="text" id="name" class="form__input" placeholder="标题">
								</div>
							</div>
							...
							<div class="col-12">
								<div class="form__group">
									...
									<textarea name="content" id="description" class="form__textarea" placeholder="文章内容"></textarea>
								</div>
							</div>
							...
							<div class="col-12">
								<div class="form__group">
									...
									<input name="introduction" id="location" type="text" class="form__input" placeholder="描述">
								</div>
							</div>
							...
							<div class="col-12">
								<div class="form__group">
									...
									<input name="lable" id="location" type="text" class="form__input" placeholder="不能超过5个字">
								</div>
							</div>
...
*/
	$(function () {
		...
		$('.form').eq(0).on('submit',function (e) {
			...
			$.post( "WriteServlet", JSON.stringify(arr))
				.done(function( data) {
					if(data==0){
